      ...
      <div className="py-8 max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-10 text-center md:text-left">
        ...
        <div className="flex flex-col items-center md:items-start">
          <p className="text-sm leading-relaxed text-gray-300">
           Our team, The Dominators , is committed to building reliable, scalable, and intelligent technology that enhances customer experience, strengthens financial ecosystems, and drives meaningful digital transformation.
          </p>
          <div className="mt-4">
  ...
  >
    R
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <p className="text-sm leading-relaxed text-gray-300">
           This website was developed for ACM ReCode: Redesign, Rebuild, and Reimagine.
